...
class CLIP_PT_tracking_cycle_panel(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        layout.prop(context.scene, "error_cleanup_limit")
...
def register():
    ...
    bpy.types.Scene.error_cleanup_limit = bpy.props.IntProperty(
        name="Error Cleanup Limit",
        default=DEFAULT_ERROR_LIMIT,
        min=1,
        description="Max markers per frame after cycle",
    )
...
def unregister():
    ...
    del bpy.types.Scene.error_cleanup_limit
