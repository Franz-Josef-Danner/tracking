...
def get_from_selected_tracks(
    ...
    try:
        ...
        scene["kaiserlich_rot_scale_thresh_rot"] = max(0, min(2, 1 - ((((dx_var_mean * 0.0036) + (dy_var_mean * 0.0067)) / 2) )))
        scene["kaiserlich_rot_scale_thresh_scale"] =  max(0, min(2, 1 - ((rel_var_mean * 0.00018) * 10000)))
