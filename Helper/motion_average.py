...
def get_from_selected_tracks(
    ...
    try:
        ...
        scene["kaiserlich_rot_scale_thresh_scale"] =  max(0, min(2, 1 - ((rel_var_mean * 0.00018) )))
        scene["kaiserlich_perspective_thresh"] = max(0, min(2, 1 - ((global_p_dev_accum_mean * 2) * 10)))
