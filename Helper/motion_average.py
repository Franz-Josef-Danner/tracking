...
def get_from_selected_tracks(
    ...
    try:
        ...
        scene["kaiserlich_rot_thresh_x"] = (dx_var_mean / 1000) 
        scene["kaiserlich_rot_thresh_y"] = (dy_var_mean / 1000) 
        scene["kaiserlich_scale_thresh_max"] = (rel_var_mean / 2000) 
        scene["kaiserlich_scale_thresh_min"] = (rel_var_mean / 100) 
        scene["kaiserlich_rot_scale_thresh_rot"] = (((dx_var_mean / 500) + (dy_var_mean / 500)) / 2) 
        scene["kaiserlich_rot_scale_thresh_scale"] =  (rel_var_mean / 1000) 
