...
Seit Version 1.66 startet der "All"-Button einen Zyklus aus Detect,
Track, Tracking Length und Playhead to Frame. Der Proxy wird dabei
nicht automatisch neu erstellt und der Ablauf kann mit Esc beendet
werden.
