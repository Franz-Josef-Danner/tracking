...
Dieses Verzeichnis enthaelt ein minimales Blender Addon für Blender 4.4 oder neuer. Kopiere den Ordner `tracking` in deinen Blender Addons-Ordner und aktiviere das Addon in den Einstellungen.
