...
registers these helpers and reuses the Tracking Cycle panel from
`combined_cycle.py` to avoid duplicate buttons.
...
- `detect.py` – helper for repeatedly detecting features until a minimum count is reached.
