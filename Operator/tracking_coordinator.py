...
def run_jump_to_frame(
    ...
    *,
    ...
    # NEU (minimal-invasiv): Ab >5 Wiederholungen marker_adapt prüfen und Optimizer-Signal setzen
    #   - KEINE Änderung am bestehenden Playhead-Verhalten
    #   - KEINE Änderung an Rückgabewerten
    if repeat_count > 5:
        try:
